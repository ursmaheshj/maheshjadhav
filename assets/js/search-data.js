...
ninja.data = [{
    ...
    section: "Navigation",
    handler: () => {
      window.location.href = "/maheshjadhav/";
    },
  },{id: "nav-blog",
          title: "blog",
          description: "",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/maheshjadhav/projects/";
          },
        },{id: "nav-repositories",
          title: "repositories",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/maheshjadhav/repositories/";
          },
        },{id: "nav-cv",
          title: "CV",
          description: "4.5 years of experience architecting and deploying scalable web applications, specializing in Python and Django to deliver high-performance, production-ready solutions.",
          section: "Navigation",
          handler: () => {
            window.location.href = "/maheshjadhav/cv/";
          },
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/maheshjadhav/books/the_godfather/";
          ...
          section: "News",handler: () => {
              window.location.href = "/maheshjadhav/news/announcement_2/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/1_project/";
            },},{id: "projects-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/2_project/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/3_project/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/4_project/";
            },},{id: "projects-project-5",
          title: 'project 5',
          description: "a project with a background image",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/5_project/";
            },},{id: "projects-project-6",
          title: 'project 6',
          description: "a project with no image",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/6_project/";
            },},{id: "projects-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/7_project/";
            },},{id: "projects-project-8",
          title: 'project 8',
          description: "an other project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/8_project/";
            },},{id: "projects-project-9",
          title: 'project 9',
          description: "another project with an image 🎉",
          section: "Projects",handler: () => {
              window.location.href = "/maheshjadhav/projects/9_project/";
            },},{id: "teachings-data-science-fundamentals",
          title: 'Data Science Fundamentals',
          description: "This course covers the foundational aspects of data science, including data collection, cleaning, analysis, and visualization. Students will learn practical skills for working with real-world datasets.",
          section: "Teachings",handler: () => {
              window.location.href = "/maheshjadhav/teachings/data-science-fundamentals/";
            },},{id: "teachings-introduction-to-machine-learning",
          title: 'Introduction to Machine Learning',
          description: "This course provides an introduction to machine learning concepts, algorithms, and applications. Students will learn about supervised and unsupervised learning, model evaluation, and practical implementations.",
          section: "Teachings",handler: () => {
              window.location.href = "/maheshjadhav/teachings/introduction-to-machine-learning/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/maheshjadhav/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%6A%32%34%31%31%39%39@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        section: 'Socials',
        handler: () => {
          window.open("/maheshjadhav/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
